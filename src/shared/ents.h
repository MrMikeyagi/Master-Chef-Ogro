...
struct physent                                  // base entity type, can be affected by physics
{
    ...
    physent *onplayer;
    int lastmove, lastmoveattempt, collisions, stacks, lastjump;          
    ...
    physent() : o(0, 0, 0), deltapos(0, 0, 0), newpos(0, 0, 0), yaw(270), pitch(0), roll(0), maxspeed(100), 
               ...
               onplayer(NULL), lastmove(0), lastmoveattempt(0), collisions(0), stacks(0), lastjump(0)
               { reset(); }
