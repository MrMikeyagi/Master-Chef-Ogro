...
struct icliententities
{
    ...
    virtual void entradius(extentity &e, float &radius, float &angle, vec &dir, vec &color) {}
    ...
    virtual bool dirent(extentity &e) {switch (e.type) { case ET_MAPMODEL: case ET_SPOTLIGHT: case ET_PLAYERSTART: return true; break; default: return false; break;}}
    virtual bool radiusent(extentity &e) {switch (e.type) { case ET_LIGHT: case ET_ENVMAP: case ET_SOUND: return true; break; default: return false; break;}}
    virtual void renderhelpertext(extentity &e, int &colour, vec &pos, string &tmp) { }
};
...
struct igameclient
{
    ...
    virtual const char *loadimage() = 0;
    ...
    virtual void setwindowcaption() = 0;
    ...
    virtual void writemapdata(FILE *f) {};
    ...
    #endif
    virtual bool allowdoublejump() {return false;}
}; 
