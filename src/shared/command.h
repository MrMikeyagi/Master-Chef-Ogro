...
enum { IDF_PERSIST = 1<<0, IDF_OVERRIDE = 1<<1, IDF_WORLD = 1<<2 };
...
#define VARW(name, min, cur, max) _VAR(name, name, min, cur, max, IDF_WORLD|IDF_OVERRIDE)
...
#define FVARW(name, min, cur, max) _FVAR(name, name, min, cur, max, IDF_WORLD|IDF_OVERRIDE)
...
#define FVARFW(name, min, cur, max, body) _FVARF(name, name, min, cur, max, body, IDF_OVERRIDE|IDF_WORLD)
...
#define SVARW(name, cur) _SVAR(name, name, cur, IDF_WORLD|IDF_OVERRIDE)
...
#define SVARFW(name, cur, body) _SVARF(name, name, cur, body, IDF_WORLD|IDF_OVERRIDE)
