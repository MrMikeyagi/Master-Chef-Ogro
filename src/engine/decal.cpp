...
{
    decalrenderer("data/items"),
    decalrenderer("data/hirato/burn", 0, 0, 1000, 100), //improve collision detection first
    decalrenderer("data/hirato/stain", 0, 10, 2000, 20),
    decalrenderer("data/hirato/ripple", 0, 10, 750, 20)
};
